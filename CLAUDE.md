...
- **Tests**: Vitest (1977 tests across 97 files as of v0.39.2). `test/global-setup.ts` builds `dist/` once before collection when the artifacts are absent, so `npm test` is correct cold or warm.
...
# Tests + eval
npm test                        # vitest run (1977 tests)
...
```
npm test                   # 1977 tests across 97 files, all should pass
