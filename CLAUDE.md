...
- **Tests**: Vitest (1933 tests across 93 files as of v0.37). `test/global-setup.ts` builds `dist/` once before collection when the artifacts are absent, so `npm test` is correct cold or warm.
...
# Tests + eval
npm test                        # vitest run (1933 tests)
...
```
npm test                   # 1933 tests across 93 files, all should pass
