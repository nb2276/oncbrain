...
- **Tests**: Vitest (1942 tests across 94 files as of v0.38). `test/global-setup.ts` builds `dist/` once before collection when the artifacts are absent, so `npm test` is correct cold or warm.
...
# Tests + eval
npm test                        # vitest run (1942 tests)
...
```
npm test                   # 1942 tests across 94 files, all should pass
