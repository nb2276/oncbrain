...
- **Tests**: Vitest (1975 tests across 96 files as of v0.39.1). `test/global-setup.ts` builds `dist/` once before collection when the artifacts are absent, so `npm test` is correct cold or warm.
...
# Tests + eval
npm test                        # vitest run (1975 tests)
...
```
npm test                   # 1975 tests across 96 files, all should pass
