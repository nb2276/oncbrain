...
**S1007 secondary: RNI adds no IDFS signal (HR 0.85, p=0.16) in RS ≤25 N1 HR+/HER2- pts; 5-yr LRR already 0.55% without it.**

> [!summary] TL;DR
> Breast locoregional de-escalation data continues to build: S1007 secondary analysis finds RNI provides no IDFS benefit in RS ≤25 N1 pts where baseline LRR is already <1% at 5 years. Non-randomized allocation limits causal inference, but findings track with post-Z0011 axillary de-escalation trends in biologically favorable subsets.

## 🎀 Breast

Locoregional intensity in RS-favorable N1 HR+/HER2- breast cancer remains guideline-unsettled; S1007's RT forms dataset now extends the oncotype de-escalation question from chemo to RT field.

### SWOG S1007 (RNI analysis)

> S1007 secondary analysis: 5-yr LRR 0.55% (BCS, no RNI) to 0.85% (BCS + RNI); IDFS not improved by RNI in favorable N1 HR+/HER2-.
...
- 🔍 Secondary analysis of S1007 (HR+/HER2-, RS ≤25, N1 1-3 nodes)
  - N=4871 with RT forms; median f/u 6.1 yrs
  - 81% received RT; 59% of RT pts received RNI
  - RNI receipt by clinician discretion, not randomized
- ⚠️ RNI not randomized: confounding by indication unavoidable despite multivariate adjustment
- ⚠️ Very low absolute LRR limits statistical power to detect IDFS differences
- 🔗 vs MA.20 / EORTC 22922: those trials enrolled higher-risk N+ pts; RS ≤25 is a biologically distinct favorable subset
- 🔗 Low LRR without RNI consistent with post-Z0011 axillary de-escalation data in sentinel-node cohorts
...
> - Would a dedicated RCT of RNI in RS ≤25 N1 pts confirm IDFS equipoise?
> - Findings applicable to pts who omit chemo on endocrine-only arm?
