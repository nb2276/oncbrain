...
**SWOG S1914: IO+SBRT no better than SBRT alone in inoperable NSCLC — OS HR 1.15, PFS HR 1.35, closed early for futility.**

> [!summary] TL;DR
> S1914 is the day's only study: atezolizumab adds nothing to SBRT in medically inoperable early/locally advanced NSCLC and increased G≥3 toxicity (12% vs 2%). The IO-ablative synergy hypothesis, positive in phase II, does not survive phase III.

## 🫁 Thoracic / Lung

Phase III data closes the door on IO+SBRT consolidation for inoperable NSCLC — futility on both OS and PFS.

### SWOG/NRG S1914 · [[NCT04214262]]

> OS HR 1.15 (p=0.63), PFS HR 1.35 (p=0.16): IO+SBRT no better than SBRT alone; trial closed early for futility.

- 📊 Efficacy: SBRT alone vs Atezo+SBRT

  | Endpoint | SBRT (S) | Atezo+SBRT (AS) | HR (95% CI) | p |
  |---|---|---|---|---|
  | OS (2-yr) | 82% | 80% | 1.15 (0.65-2.01) | 0.63 |
  | PFS (2-yr) | 71% | 60% | 1.35 (0.89-2.06) | 0.16 |

- 🔍 Phase III; N=403 eligible, medically inoperable or surgery-declined, T1-3N0M0 ≤7cm, ≥1 high-risk recurrence factor
- 🔍 SBRT 3-8 fx BED ≥100 Gy; atezolizumab 1200mg Q3W × 8 cycles (SBRT initiated cycle 3)
- 🔍 Closed at 1st interim analysis for futility on both OS and PFS per design; median f/u 12 months
- 📊 Failure patterns: SBRT vs Atezo+SBRT

  | Pattern | SBRT (S) | Atezo+SBRT (AS) |
  |---|---|---|
  | Local | 7% | 13% |
  | Regional | 2% | 3% |
  | Distant | 4% | 5% |
...
- ⚠️ Former/never smoker subgroup: AS worse OS HR 2.50 (1.11-5.59, p=0.03) and PFS HR 2.16 (1.15-4.04, p=0.01); exploratory
- 🔗 Prior phase II ([[PMID 37478883]]) suggested IO benefit with SBRT; phase III does not confirm
...
> - PD-L1 or tissue/blood biomarker subset that might benefit from IO addition
> - Whether different IO sequencing (adjuvant-only) changes the null result
